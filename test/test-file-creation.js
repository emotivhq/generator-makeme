...
describe('makeme generator', function () {
  ...
  function generatorTest(generatorType, name, mockPrompt, callback) {
    gen.run(function () {
      ...
      afGenerator = helpers.createGenerator('makeme:' + generatorType, deps, [name], {
        skipInstall: true
      });
  ...
  beforeEach(function (done) {
    ...
    helpers.testDirectory(path.join(__dirname, 'temp'), function (err) {
      ...
      gen = helpers.createGenerator('makeme:app', deps, [], {
        skipInstall: true
      });
      done();
    }.bind(this));
  ...
  describe('running app', function() {
    ...
    describe('with default options', function() {
      ...
      it('should use existing config if available', function(done) {
        ...
        var gen = helpers.createGenerator('makeme:app', [
          '../../app',
          '../../endpoint',
          [
            helpers.createDummyGenerator(),
